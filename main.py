...
imgNoise_fft = sp.fftpack.fft2(imgNoise)
imgNoise_fft_filtered = imgNoise_fft.copy()

# Checking the Fourier transform
from matplotlib.colors import LogNorm
# A logarithmic colormap
plt.imshow(np.abs(imgNoise_fft_filtered), norm=LogNorm(vmin=5))
plt.colorbar()
plt.show()
"""
